...
Firstly, exploratory data analysis was used to understand the data better, learn the different data characteristics, look out for useful pattern, null values and how the values of different variables are distributed. This is a very important first step in data analysis and data science. Feature Engineering was used in transforming the raw data into useful features for the machine learning model.

The Algorithm used in this project is Random Forest Classifier. 

**Random Forest Classifier** This is a supervised machine learning algorithm which is based on ensemble learning. This was used to train a machine learning model to predict the target out which is customer booking completed or not completed. This model was able to predict the target outcome with an accuracy 0f 0.8496 using 100 decision-trees. The performace of the model was evaluated using **Confusion Matrix** which gives us a summary of correct and incorrect predictions broken down by each category.
